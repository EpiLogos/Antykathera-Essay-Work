...
## Warrant
The selection sequence is technically inspectable; [[submission-package/essay/symbolon/episteme/sources/quotes/vaswani-et-al-2017-attention|Vaswani et al.]] anchors the attention-based architectural context. The sequence supplies a bounded analogue to [[submission-package/essay/symbolon/episteme/concepts/apoha|apoha]] at the level of differential determination. It is not a historical or doctrinal identity.
...
Current searches found no peer-reviewed precedent for the apoha–selection comparison. It therefore remains the essay's own **Argued** bridge. McGilchrist enters only as a contemporary witness for the danger of an overextended selection-oriented cognitive style, not as technical evidence for the analogy.
...
The broader transverse context is governed by [[PRE-39-SIGNAL-LINK-TATTVA-WORLD-AGENCY-CONFORMANCE]] so that later AI/LLM parallels do not reduce the tattvic / antaḥkaraṇa field to one-to-one mechanism matching.
