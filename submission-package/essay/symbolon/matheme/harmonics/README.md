...
- [9/8 whole tone and retained remainder](whole-tone-return.md)
- [Pythagorean comma](pythagorean-comma.md)
- [Wheel, cycle, interval and octave](cycle-interval-octave.md)
- [Musical resolution of Arche-Topos](arche-topos-musical-resolution.md)
- [Metonic / Antikythera cycle](metonic-antikythera-cycle.md)
- [Cymatics and standing waves](cymatics-standing-waves.md)
