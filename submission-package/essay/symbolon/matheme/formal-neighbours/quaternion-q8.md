...
The real quaternion algebra has basis `1,i,j,k` with `i²=j²=k²=ijk=−1`. Multiplication gives `ij=k`, `jk=i`, `ki=j`, while reversing the order negates each result. The [core spine](../../episteme/sources/internal-corpus/taylor/taylor-2026-core-theorems-pithy/SOURCE.md) supplies the native phase relation beside which this formal neighbour is admitted.
...
This record returns-to [complex orientation](../ql/complex-orientation.md), [A18](../../episteme/arguments/A18-Primordial-Symbolon-and-Its-Eight-Determinations.md), and [translations](../mono-poly/translations.md). A valid comparison must preserve the order of products and name which cover it invokes.
