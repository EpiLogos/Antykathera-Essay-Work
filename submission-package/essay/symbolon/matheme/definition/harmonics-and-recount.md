---
title: "§2–§3 — 4+2 → (3+1)+2"
record_id: matheme-definition-harmonics-and-recount
record_type: matheme
register: matheme
...
## #0 — A counted relation remains a relation
...
The [Binary Explication](../../episteme/sources/internal-corpus/taylor/taylor-2026-binary-explication/SOURCE.md), File 1 §§2–3, sources this recount. [Self-Identity](../../self-identity.md) grounds its whole-bearing office.
...
For the harmonic reading, hold `=/≠` as one middle. The three terms are now `=`, `=/≠`, and `≠`. Their difference remains inside the enclosing act represented by the brackets. The fourth reappears as that contextual holding, so the recount is:
...
There are three read terms and three operative/contextual marks: `/`, `()`, and `=`. Pairing them yields the compact expression:
...
The [process register](../process/README.md) extends other precise readings of the same field, including perspectival counting and complementary symmetries. The [curated spine](../../episteme/sources/internal-corpus/taylor/taylor-2026-core-theorems-pithy/SOURCE.md) gives the primary subject-account in which `3:3` also means `3:1`. These are named operations at different grains; the local graphic packing does not replace the personed derivation.
