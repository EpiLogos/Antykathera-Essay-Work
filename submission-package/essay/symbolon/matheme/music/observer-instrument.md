...
The [musical field](field.md) **defines** possible lens, mode, cluster and bass choices. A performance makes a particular selection audible in time. File 4's [“Observer, Instrument, and the Musical-Epistemic Return”](../../episteme/sources/internal-corpus/taylor/taylor-2026-binary-explication/SOURCE.md) **sources** the observer’s office: return the sounding to the operation it was intended to perform.
