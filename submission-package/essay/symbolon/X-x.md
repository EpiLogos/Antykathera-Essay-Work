---
title: "X/x — Determining Capacity and Its Particular"
aliases:
  - "X/x — Determining Capacity and Its Particular"
record_id: symbolon-x-x
record_type: root-relation
register: symbolon
claim_status: Derived
source_relation: "Extracted internal derivation; Argued named refractions"
---
...
The [core-theorems spine](episteme/sources/internal-corpus/taylor/taylor-2026-core-theorems-pithy/SOURCE.md), §II(c), fixes `X/x` at **#3, Pattern**. File 1's poem gives the relation the line “Sojourning through time yet unmovingly presidential.” The small *x* is the temporal sojourn, while *X* presides as the capacity that becomes legible through that journey.

Their continuity does not require each instance to repeat the previous one unchanged. A pattern can remain recognisable through altered occasions because the relation sustains more than a single completed face. Conversely, a capacity that never became determinate would supply no instance through which its pattern could be recognised.

`X/x` therefore joins `−/+` in **Becoming** and in the complementary **Text–Texture** fold. Force gives pattern its life; pattern makes force readable across its instances. Their shared centre does not make dynamis and pattern synonyms. One conducts the pulse, the other its recognisable recurrence.
...
A pattern is lived from somewhere. [AM/IS](AM-IS.md) extends its recurrence into first-person presence, second-person relation, and third-person describability. The particular face can become an account, and the person whose life it describes can answer to and through that account.

The root returns-to [A18](episteme/arguments/A18-Primordial-Symbolon-and-Its-Eight-Determinations.md) and [§3 · #0, Eight Determinations](../section-rooms/04-mathematical-substrate/movements/25-s3-p0-eight-determinations.md). [Self-identity](self-identity.md) grounds the unfolding through difference; the [spine-index](eight-determinations.md) gathers the onward relation to person, horizon, and return. The achieved *x* returns a new possibility of determination to the field. Its capacity remains legible through what it can next become.
