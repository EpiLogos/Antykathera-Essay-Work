---
title: 'S3 — Software Factory: transformation'
record_id: S3
record_type: product
register: episteme
claim_status: Argued
...
## #0 — Becoming otherwise

**Software Factory is transformation: the process through which intention, action, encounter and learning become changed form.** Development is not merely production of artifacts. Something is wanted, a possibility is entertained, a form is attempted, actuality resists or confirms it, and what happened is gathered back into the conditions of what can happen next.
...
The Processual lens gives **Concrescent desire · Actual occasion · Ingression · Eternal objects · Community integration · Satisfaction/Perishing**.

**Concrescent desire** is the lure or pressure by which something wants to become. **Actual occasion** is the concrete event in which that possibility is attempted. **Ingression** is the entry of possible form into actuality. **Eternal objects** name the available forms, patterns and determinations through which the occasion can take shape. **Community integration** asks whether the resulting form can enter the wider world that must sustain, interpret and live with it. **Satisfaction/Perishing** names both completion and passage: the finished occasion becomes inherited condition for what follows.

This gives development its recursive structure. Intention alone is not transformation. Neither is execution alone. Possibility becomes consequential by entering actuality; actuality answers; the achieved or failed form passes into the next ground.
...
The conjugate lens gives **Aether · Earth · Water · Air · Fire · Salt**. Transformation is not abstractly procedural; it takes place through differentiated modes of composition.

**Aether** is the open field of possibility in which the work can begin. **Earth** gives resistance, material, inherited body and constraint. **Water** carries flow, adaptation and mixture. **Air** mediates, communicates, abstracts and relates. **Fire** transforms through energetic difference, conflict, testing and irreversible passage. **Salt** precipitates the attained form: the result that can now persist, circulate and become material for another becoming.

These are not labels to assign mechanically to software phases. Their office is to keep heterogeneous transformation visible. A development process gathers ideas, existing matter, communication, energetic labour, resistance and stabilised form. If any one of these is treated as the whole, the relation becomes impoverished: pure ideation without material resistance, execution without interpretation, communication without consequence, or output without return.

The alchemical image also guards against the fantasy of frictionless transformation. Becoming costs something. Time, attention, labour, compute, institutional permission and displaced alternatives are part of the event. What precipitates as a “clean” artifact may conceal who bore those costs.
...
The holographic requirement follows. A project can carry, at its own scale, the relation among source, paradigm and projected form without pretending to contain the whole World from which those relations arise. The Project/ProjectMap offices therefore gain force by retaining provenance and return, not by becoming a master representation. A project which can only interpret resistance through its own current categories has become developmentally closed even if its artifact production remains fast.

## #4 — Labour, Power and developmental consequence
...
Factory completes its movement when the result becomes more than an artifact: it becomes a **new condition of further becoming**. Code is integrated, a concept is clarified, a source relation is corrected, a method is retired, a project map changes, a person learns, an institution revises its practice. Satisfaction perishes into inheritance.

This is the positive meaning of return. The field does not circle back unchanged. It becomes capable of another movement because the previous movement has altered what is now possible, credible, desirable or required.
