...
This temporal reading also guards against treating novelty as pure addition. Development can require relinquishment. A capability that remains permanently active may prevent a more fitting relation from forming. Winter has a positive office because potency includes the capacity *not* to enact what one could enact.
...
The Power argument enters AIKit wherever capability becomes permission or selection. To expose a tool is already to alter the practical horizon; to rank one method as relevant is to shape what will likely happen next. The question is not simply whether a capability can execute, but whose purposes, permissions and consequences govern its activation.

Trust cannot be reduced to availability. A familiar tool may be unfit for this task; an unfamiliar one may be exactly required. Repeated successful use can ground a fitness observation without granting unrestricted future authority. The returned evidence must be able to change the capability relation itself: tighten scope, expand it, retire an option, change a method, or reopen what had been excluded.

Here the distinction between power and possession becomes ethical. A Life can have the power to act without the right to act in every shared field. Another’s availability to encounter does not make them a resource. A source’s accessibility does not abolish its provenance or conditions. Potency worthy of the whole includes the capacity to respect a limit.
