...
“Dreamcode” and “Dream-machine” name the computational register of this same problem: a bounded, rule-governed world through which an agent perceives and acts. The operative question is horizon formation. What can be encountered depends on powers and exclusions that need not appear among the encountered objects. Technical implementation matters because it lets some of those powers become explicit, mutable and consequential rather than leaving Māyā at the level of metaphor.
