...
It is the venue frame *The Return of Zero* enters and reorients. The essay opens not with the Antikythera mechanism but with the formal limit ([[01-s01-p0-question-before-mechanism|§0/1 · #0 — The Question Before the Mechanism]]), recasting planetary computation as a question about the subject that planetary systems displace. [[Agentworld]] reorients the field toward hybrid human–AI sociality; the essay's closing return ([[48-s50-p5-ahi-planetary-return|§5→0 · #5→0 — AHI and Planetary Return]]) *offers* QL/MEF and [[18-trust-faith-formal-limit|Trust]] as contribution — planetary intelligence as a commons with no view from nowhere. Kept distinct from [[11-mono-poly-whole-and-many|Mono-Poly Planetary Intelligence]], the essay's own term for wholeness-through-plurality rather than the discipline it addresses. (Reorientation: **Argued**; the QL contribution: **Offered**.)
