...
Taylor's [[symbolon/episteme/sources/internal-corpus/taylor/taylor-2026-symbolon-dynamics/SOURCE|Symbolon Dynamics]] sources the coordination: symbolic amplification moves among charts, while the response to a symbol changes the interpreter and the later trajectories available to that life. Frank's protected encounter with [[symbolon/episteme/sources/psychology/van-eenwyk/van-eenwyk-1997-archetypes-strange-attractors/SOURCE|Van Eenwyk]] grounds the importance of this known→unknown→known transformation. Its copied quotations remain leads; the book's external passages are locator-needed. [[symbolon/episteme/concepts/C32-Archetype|C32]] defines determining capacity relative to its manifestations; native `X/x` supplies its QL relation before the psychic refraction.

Music gives retained difference a temporal operation. The squared fourth `16/9` reaches the octave through the `9/8` whole-tone: `(16/9)(9/8)=2`; equivalently, `(4/3)(9/8)(4/3)=2`. [[symbolon/episteme/sources/internal-corpus/taylor/taylor-2026-ql-musical-derivation-v3/SOURCE|Musical v3]] sources this exact kernel. The interval is not a topological hole; each retains a difference through its own form of completion. QL coordinates that operation after the primary `3:3=3:1` subject-account has been read. Music, geometry and psyche do not borrow one another's evidential status.
...
Changing a whole perspective and holding several perspectives together perform different work. The Necker-flip supplies the first; the contextual `180°→360°` figure supplies the second. [[symbolon/episteme/concepts/C52-Dimensional-Reframing-at-Zero-and-Infinity|C52]] defines reframing at the formal limit. Context opens an organised availability of views and transformations while each observer remains situated. It does not confer an omniscient panorama.

## #5→0


[the ancient-philosophy companion](../histories/traditions-and-disciplines/ancient-philosophy/DEVELOPMENT.md#ancient-instrument-sign) **compares** coordinated mechanical outputs with the differential field while preserving the Hellenistic object, modern reconstruction and native derivation as distinct registers.


The [Pauli egg whole](../../mytheme/worlds/analytical-psychology/pauli-egg-dream/WHOLE.md#pauli-egg-seven-pictures) **compares** its conjugate quotient with the complex-phase aperture: for real δ, e^{iδ/2}/e^{−iδ/2} = e^{iδ}, whose modulus remains one. A fixed angle gives a point; varying the angle traces the circle. The seven-picture telling preserves spontaneous division and the dreamer’s later participation as distinct events, while the admitted programme brings this exact mathematical relation into its whole-form refraction. Neither the formula nor Pauli’s interpretation supplies the native eightfold. Exact egg-to-QL appointments and the newly specified A19 comparison remain human-amplified: no; the programme’s already admitted office retains its force.

The [Antikythera attunement whole](../../mytheme/worlds/frank-taylor/antikythera-attunement/WHOLE.md#antikythera-coordinated-cycles) **figures** differentiated placement through a situated dial that coordinates heterogeneous cycles for a reader. Calendrical and eclipse returns keep their respective offices, including the difference between exact gearing and astronomical residual. The mechanism gives the differential field a bounded technical image; its circular display supplies no further topological proof.

The [Mother, Assumption and chiasm whole](../../mytheme/worlds/frank-taylor/mother-assumption-chiasm/WHOLE.md#mother-wheels-wings) **figures** orientation through a wheel whose form persists as the view reverses. The compound `(0/1)/(1/0)` carries both orientations in operative relation, giving placement a lived image. Taylor’s corrected wings retain blockwise recognition and complementary folds as distinct partitions; the embroidery supplies no geometric theorem.

The [travelling-jigsaw whole](../../mytheme/worlds/frank-taylor/travelling-jigsaw-atlas/WHOLE.md#jigsaw-mathematical-witness) **figures** the field of placements through local charts, their overlap rules and the cover on which a return retains displacement. A chart, a transition and a generating loop have different offices. Their explicit relations make the travelling picture answerable to the differential field rather than to resemblance among rounded shapes.

The [stained-glass whole](../../mytheme/worlds/frank-taylor/stained-glass-refraction/WHOLE.md#stained-glass-atlas-complement) **figures** differential placement through transmission, obstruction, angle and a changing interior display. Its atlas complement retains chart domains and transitions as a distinct operation; its source distinction also keeps chart coordination separate from attractor dynamics. The whole returns the viewer and apparatus within the field they disclose.

The winding creature figures the field of placement through its operative opening, body and distinct directions of return. This **returns-to** [the uroboros whole](../../mytheme/archetypal-ground/uroboros-trickster/WHOLE.md#uroboros-interposition).
