...
This makes A09 one of the essay's deepest accounts of **paradigmatic existence before explicit paradigm**. A Life does not first stand outside a complete world and then adopt a worldview about it. Its powers, limits, means of discrimination, inner instrument, temporal order and material situation participate in the very form in which a world becomes available. [C41 — Objective Internality](../concepts/C41-Objective-Internality.md) develops the authorial generalisation as lived/enacted paradigm; the tattvic account remains a specific Śaiva genealogy, not the historical source of the modern term.
...
This is the pressure passed to Objective Internality and the computational register: memory, prompt, model, tools, policy and judgment can constitute an operative interior whose determining activities are inspectable. Their significance is precisely that they make **pramāṇa**, the mediating means, technically tractable. A09 supplies the genealogy of contraction; A26 develops context-world constitution; A14 follows the repeatable processes through which those conditions become consequential. The technical field does not need to be inflated into the knower-pole to carry this philosophical force.

The restored S field now receives this genealogy without converting products into tattvas. **S0–S5 are not a six-item substitute for the thirty-sixfold field.** They are six whole aspects through which a finite Objective Internality can be articulated once worldhood has become operative: [Central](../products/S0-Central.md) carries meaningful continuity within the contracted history; [Actuation](../products/S1-Actuation.md) carries the living events by which differentiation becomes consequential; [AIKit](../products/S2-AIKit.md) carries the apportioned horizon of powers; [Software Factory](../products/S3-Software-Factory.md) carries transformation from possibility into changed form; [Workcell](../products/S4-Workcell.md) carries concrete being-there, resistance and availability; [Quaternal Logic](../products/S5-Quaternal-Logic.md) carries the relation of these finite distinctions to containing wholes. Their composition is one engineered paradigm within the general lived pattern C41 names.

The relation is exact at the level of office and bounded at the level of doctrine. Kalā is not “AIKit,” Māyā is not “Workcell,” and antaḥkaraṇa is not a software harness. The tattvic field shows why **finite capacity, knowledge, desire, time, order, instrument and world belong to the constitution of lived worldhood rather than being accessories around it**. The product field asks how an artificial agent's constructed world can make analogous constituting relations inspectable and revisable. The cross-reading is Argued/Offered; the source-specific metaphysics and the implemented architecture retain separate warrants.

### Declared field

**Concept dependencies:** C13 Prakāśa–Vimarśa, C14 Māyā / Operative Measure, C15 Paśu, C16 Antaḥkaraṇa, C17 Vikalpa–Saṃkalpa, C18 Apoha, C19 Recognition, C41 Objective Internality.

**Consequences:** A14, A16, A19, A21, A26 and A35; S0–S5 receive the finite-world genealogy at the Objective Internality culmination.
