...
The [Symbol / Account / Trust whole-field — Account does not replace source](../etymologies/symbol-account-and-trust/WHOLE-FIELD.md#account-does-not-replace-source) **qualifies** this operation at evidence register 3. The criterion remains visible in the result, allowing a disputed comparison to return to its denominator without losing the calculation’s earned exactness. The resulting distinction **returns-to** that whole field with the consumer’s own source and evidential limits retained.

The [Chinese rectification case](../etymologies/symbol-account-and-trust/HISTORICAL-BRANCHES.md#chinese-rectification-of-names) **compares** a designation’s practical standing with the account of its office: Analects 13.3 connects names to speech and action, then to ritual and punishment. A15’s return keeps the measure and its jurisdiction in view when it judges a result. A correctly recorded title does not discharge the obligations it declares. The received political sequence remains distinct from the native ratio derivation.

The [Arabic E4 case](../etymologies/symbol-account-and-trust/HISTORICAL-BRANCHES.md#arabic-reckoning-and-names) **qualifies** the office of a count. The ninety-nine-Names report makes enumeration or retention part of an undertaking; the number alone neither identifies every Name nor performs invocation. This returns A15’s requirement to state what is counted, under which textual warrant, and what further act the count is meant to serve. It supplies no derivation of the native numerical field.

The [Sanskrit enumeration case](../etymologies/symbol-account-and-trust/HISTORICAL-BRANCHES.md#sanskrit-enumeration-and-discriminative-practice) **compares** this register-3 obligation through Kārikā 3’s twenty-five principles under different causal descriptions. The count remains exact while the account retains what is productive, produced, both or neither. Kārikās 4–6 separately state how the claims are known. Returning the criterion and warrant preserves the operation without identifying its Sāṃkhya ontology with the native ratio field.

The [Hebrew SPR case](../etymologies/symbol-account-and-trust/HISTORICAL-BRANCHES.md#hebrew-spr-counting-writing-and-entrusted-work) **compares** record and consequence through the repair narrative of 2 Kings 12, placed in Jehoash’s twenty-third regnal year. Counted money, repaired fabric and faithful work have distinct offices; the Hebrew text uses different roots for the scribe, counting, reckoning and faithfulness. At register 3, the resource account returns with the material purpose that can expose a failed arrangement. The regnal setting belongs to the narrative, not an independently established absolute date. Neither an exact total nor a shared English gloss completes that return.
