...
[Argument field](../arguments/README.md) · [Other face: A19 — Complex as Local Arbitration Regime](../arguments/A19-Complex-as-Local-Arbitration-Regime.md) · [Shared A/C root](AC.md)
<!-- /paired-field-navigation -->
...
The page **returns-to** [A19 — Complex as Local Arbitration Regime](../arguments/A19-Complex-as-Local-Arbitration-Regime.md) and to the root [A/C](AC.md): a local arbitration that knows its office answers, in its own register, the respect for experience the ruling places over every frame.
