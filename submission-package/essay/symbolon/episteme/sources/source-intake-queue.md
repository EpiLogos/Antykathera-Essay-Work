...
- **French power-theory cluster, admitted 2026-08-02:** six source houses now stand in the source bank — [[Baudrillard — Forget Foucault (1977)]] (power as simulated sign; the forgetting; sex represses the failure of desire — the step past Foucault's external discipline to desire-based self-discipline), [[Baudrillard — Symbolic Exchange and Death (1976)]] (the code; the four values incl. sign-value and symbolic exchange; the orders of simulacra), [[Baudrillard — Simulacra and Simulation (1981)]] (the precession of simulacra; the four phases of the image; the hyperreal), [[Baudrillard — Fatal Strategies (1983)]] (the object wiser than the subject; the masses; irony as method), [[Baudrillard — The Transparency of Evil (1990)]] (obscenity; the fractal stage of value; the perfect-crime motif), and [[Foucault — The History of Sexuality, Volume 1 (1976)]] (the repressive hypothesis refuted; power-knowledge; bio-power). All six are **intake-stage houses**: bibliographic identity verified against publisher records and the standard bibliography; no edition selected, no passage card quotation-ready (chapter-level leads only). Corpus placements already live and recorded in-house: power-knowledge inextricability endorsed in the P1 Jorjani notes; Foucault's episteme-archaeology placed at "#4 without #5 or #0" in the immutable-subject document; the care-of-the-self Foucault cited in the MEF-plugin resources; the Agentworld relays already carried by the [[Simulation]] concept node. Outstanding debts: edition selection and print collation for all six; decide whether *The Order of Things*, *Discipline and Punish*, *In the Shadow of the Silent Majorities*, and *The Perfect Crime* receive their own houses; keep Deleuze's "Postscript on the Societies of Control" as a recorded neighbour; gate all use on the Poster/Norris/Kellner/Wolin critiques. The argument relations are recorded in-house as candidates for the harmonisation pass; no placement decisions are made at the house level.
...
- **Homeric-apparatus scholarship cluster, admitted 2026-07-18:** four source houses now stand — [[detienne-vernant-1978-cunning-intelligence|Detienne and Vernant — Cunning Intelligence in Greek Culture and Society (1978)]] (mētis; "The Circle and the Bond" chapter needs print collation, ch. 10 / pp. 269–75), [[burkert-1960-lied-ares-aphrodite|Burkert — Das Lied von Ares und Aphrodite (1960)]] (technē-over-physis thesis; German sentences and the 1997 English translation span need extraction), [[brown-1989-ares-aphrodite-laughter|Brown — Ares, Aphrodite, and the Laughter of the Gods (1989)]] (*Phoenix* 43 acquisition for page locators), and [[Phillips — Moicheia and the Unity of Greek Law]] (venue and year unresolved — identify the published volume). The Murray house now carries passage cards q004–q008 (Helios's σκοπιή, δεσμοὶ τεχνήεντες, ἕεδνα/μοιχάγρια, Hermes's quip, the ἐγγύη surety exchange); all need the Perseus reread noted in-card. The diabolē naming and every technological reading remain the essay's Argued moves.
...
- **Catuṣkoṭi/FDE cluster, admitted 2026-07-18:** six source houses now stand — [[priest-2010-logic-catuskoti|Priest — The Logic of the Catuskoti (2010)]] (open access; the quotation-ready formal core: FDE values as subsets of {T,F}, the fifth status *e* and its infectiousness, evaluations as relations, the two-truths formalisation), [[priest-2018-fifth-corner|Priest — The Fifth Corner of Four (2018)]] (chapter arc from Quintum Non Datur through Jizang's hierarchy to Dōgen; copyright-year 2018/2019 check open), [[garfield-priest-2003-limits-of-thought|Garfield and Priest — Nāgārjuna and the Limits of Thought (2003)]] (inclosure schema; journal collation pending), [[kapsner-2020-cutting-corners|Kapsner — Cutting Corners (2020)]] (the gate: rejection of the fifth value — QL's #0-as-precondition sidesteps it, and the citation says so), [[siderits-tillemans-chakrabarti-2011-apoha|Siderits, Tillemans, and Chakrabarti — Apoha (2011)]] (nominally/verbally bound negation; book collation needed), and [[priest-2014-one|Priest — One (2014)]] (gluon theory as Western formal neighbour of mono–poly; book collation needed). Manifold atlas/transition-function textbook source (Hatcher suffices or add a differential-geometry primary) for ledger row 35.
...
- **Two-modalities witness cluster, admitted 2026-07-18:** [[mcgilchrist-2009-master-emissary|McGilchrist — The Master and His Emissary (2009)]] (edition decision 2009 vs 2019 open; print locators for all quotes; the Nietzsche-footnote text; criticism dossier carried in-house — Grayling via Willis/BJGP 2010, the RBB 2019 "hemispheric homunculi" symposium) and [[mcgilchrist-2022-resist-machine-apocalypse|McGilchrist — Resist the Machine Apocalypse (2022)]] (First Things; month/URL verification). Admitted under the gate: cross-register witness for asymmetry only, never neuroscientific derivation. [[jorjani-2016-prometheus-atlas|Jorjani — Prometheus and Atlas (2016)]] remains a **book-level acquisition contract**: the P1 notes cover the Prologue only; the Atlas/cartography chapters, any Gestell material, and pagination (416 vs 468 pp. discrepancy) await the physical book.
