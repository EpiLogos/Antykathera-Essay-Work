...
type: source-house
canonical_path: essay-workshop/sources-texts-references/source-bank/sources/computer-science-ml/rafailov/rafailov-et-al-2023-dpo/SOURCE.md
canonical_sha256: ff0c1d4aa4ac9cdb2e6326bca71c95994f90f605c55067e65208004c609cb1a5
---
...
Exact text, edition-specific locators, verification method, and consumer mappings: Quotes — Rafailov et al. Direct Preference Optimization (2023).
...
- **Consumers:** [40-s5-p3-preference-hidden-zero](../../sections/40-s5-p3-preference-hidden-zero.md); Mono-Poly Trust; [Immutable Gap and Meta-Sign](../../arguments/01-immutable-gap-and-meta-sign.md); [Paradox as Cross-Register Hinge](../../arguments/15-paradox-as-cross-register-hinge.md).
...
| `rafailov-et-al-2023-dpo-q001` | `rafailov-et-al-2023-dpo` | official NeurIPS PDF p. 4/14, §4, after Eqs. 4–5 | quotation-ready | `40-s5-p3-preference-hidden-zero` | Mono-Poly Trust; [Immutable Gap and Meta-Sign](../../arguments/01-immutable-gap-and-meta-sign.md); [Paradox as Cross-Register Hinge](../../arguments/15-paradox-as-cross-register-hinge.md) | preference/reference-policy mechanism | Quotes — Rafailov et al. Direct Preference Optimization (2023) |

| `rafailov-et-al-2023-dpo-q002` | `rafailov-et-al-2023-dpo` | official NeurIPS PDF p. 5/14, §4 “DPO outline” | quotation-ready | `40-s5-p3-preference-hidden-zero` | Mono-Poly Trust; [Immutable Gap and Meta-Sign](../../arguments/01-immutable-gap-and-meta-sign.md); [Paradox as Cross-Register Hinge](../../arguments/15-paradox-as-cross-register-hinge.md) | proxy-baseline limitation | Quotes — Rafailov et al. Direct Preference Optimization (2023) |
