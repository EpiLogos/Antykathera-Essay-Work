...
- P5
- L2'
claim_status: Derived / Argued / Offered per image row
tags:
...
- argument-map/visual
aperture:
  novice: 'The essay''s rulebook for pictures: every diagram, myth-image, or device earns its place by doing one exact job in the argument — nothing enters because it looks profound.'
...
type: concept
canonical_path: essay-workshop/nodes/concepts/mathematical-artistic-image-register.md
canonical_sha256: ccbeace59064115e2c55b51d0a75c85d93616eee57a22456606314afd7111282
---
...
Each image carries one argumentative operation. An image earns main-text space when the reader can say what changes in the argument by seeing it — and the source's own evidential level remains visible: a theorem or construction can carry a **Derived** mathematical claim; an artwork, mytheme, mystical formula, or engineered device carries an **Argued** or **Offered** disclosure; no artistic resemblance inherits the authority of the mathematics it sits beside; no mathematical diagram is treated as exhaustive of the lived or metaphysical field it renders.

## The register

| Station | Image | Operation carried | Status and use |
|---|---|---|---|
| §0/1 | [Cusa's](../references/sources/cusa-on-learned-ignorance.md) polygon approaching the circle | Exact finite approximation deepens while its non-coincidence with the limit remains exact | Argued image for the formal limit |
...
| §0/1 | Eckhart's ground, desert, spark, and Word ([Flasch 2015](../references/sources/flasch-2015-meister-eckhart.md)) | Predication intensifies until transparent to the no-thing it cannot predicate | Mystical/poetic Argued disclosure, not theorem |
...
| §3 · #2 | Bohm's spinning wheel and straight-running thread ([1975 dialogue](../references/sources/bohm-krishnamurti-1975-05-18-dialogue.md)) | Phase changes while an invariant relation runs true through rotation | Primary-transcript image beside complex modulus |
...
| §3 · #3 | Riemann sphere and stereographic projection | Obstruction becomes position under a changed space | Derived — see [Dimensional Reframing](dimensional-reframing-at-zero-and-infinity.md) |
| §3 · #4 | Fundamental square, universal cover, torus circulations | Quotient, two windings, local return with global displacement, `χ(T²)=0` circulation | Derived topology; QL reading Argued — [Toroidal Circulation](../arguments/17-toroidal-circulation-arche-topos.md) |
...
| §2 · #3 | The two nets with Gestell between them | Indra's recursive reflections against Hephaestus's arresting bonds, with the counterfeit gathering naming their difference in the technological register | Mythemes plus Argued philosophical naming — [counterfeit-gathering](counterfeit-gathering.md) |
...
Related: [Paradox as Cross-Register Hinge](../arguments/15-paradox-as-cross-register-hinge.md) · [Bohmian Enfoldment and Dialogical Return](../arguments/16-bohmian-enfoldment-dialogical-return.md) · [Toroidal Circulation and the Arche-Topos](../arguments/17-toroidal-circulation-arche-topos.md) · [Arche-Topos as Differential Field](../arguments/04-arche-topos-topology-music.md)
