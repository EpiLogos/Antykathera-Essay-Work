...
- mcgilchrist-2022-resist-machine-apocalypse
tags:
...
- position/p1
type: section
canonical_path: essay-workshop/nodes/sections/38-s5-p1-apoha-softmax.md
canonical_sha256: 361ae2300124cdcf9fb1947ac6381ba66edd8bee1a9ad39aef403b51ec04b0c4
coordinates:
- §5
- '#1'
---
...
## Warrant
The selection sequence is technically inspectable; [Vaswani et al.](../references/sources/vaswani-et-al-2017-attention.md) anchors the attention-based architectural context. The sequence supplies a bounded analogue to [Antykathera-Essay-Work/essay-workshop/nodes/concepts/apoha](../concepts/apoha.md) at the level of differential determination; it is not a historical or doctrinal identity.
...
**QL trace:** selected `1`, relevant excluded field `0`, and the contextual slash that made the contrast operative. This turns “reasoning” from a retrospective story into a partially inspectable differentiation history. Those contrasts inhabit [§5 · #2 — J-Space](39-s5-p2-j-space.md).
