# §2 — Two Logics of Two — DRAFT-1

**Standing:** argument draft from room + A/C + enrichment spine; literary packaging incomplete. Not for acceptance.
...
**Dia-ballein `(+1)/(−1)`** makes a difference definite: it distinguishes, measures, chooses and gives a refusal its edge. **Sym-ballein `(0/1)/(1/0)`** gathers the differentiated terms through the relation which gives them meaning and force. Both are positive operations. Severance denies that relation while continuing to depend upon it; fusion absorbs the difference from which a reply could come. The classical accounting comes first because it is the dominant logic of modern formal and technical systems—and because its failure-modes are already at work wherever a cut forgets the field that made its poles.
...
The trust field gives this movement its lived sequence rather than a glossary. *Fides* names reliance already enacted when someone approaches a witness, opens a language, or asks a question before the answer can certify the asking. *Topos* situates that reliance: this source, these permissions, this person's competence and vulnerability, the room in which a reply can land or fail. *Logos* makes reasons and claims articulate enough to be compared and contested. *Nomos* distributes instituted effect—whose answer can change action, by which rule, through which office—so that an impeccable transcript is not yet an authorised consequence. Repeated arrangements thicken into inheritance; *natio* turns attention to the belonging into which later people arrive, living inside an order before they can examine how it was made.[^trustfield] Examination can change what is entrusted. *Credere* carries confidence, lending and entrusting into a renewed undertaking: fides before arbitration and credere after arbitration name the essay's movement through these offices, not a chronology of Latin meanings. What inquiry has learned must enter the new commitment, or a declaration of renewed trust merely renews the exposure under which the previous promise failed. A changed undertaking specifies someone able to act and something they are prepared to answer for.
...
The goddesses remain in their own houses for shame. The male gods arrive and laugh. Slow Hephaestus has caught swift Ares: craft has defeated speed, and the adulterer owes a fine. Yet the sight does not bind its witnesses to one valuation. The goddesses have stayed away for shame; the male gods laugh at the ingenious capture, and one draws the lesson that the slow has caught the swift—craft defeating speed, the adulterer owing a fine. Apollo asks Hermes whether he would accept such bonds for the pleasure of lying beside golden Aphrodite. Hermes answers that he would welcome three times as many bonds, with every god and goddess looking on, if he could share her bed. The laughter grows. What the maker exhibits as intolerable humiliation, another god regards as a price worth paying; the deterrent has become an inducement, and the spectators' desire enters the apparatus as currency.
...
What §3 must preserve is already specific here: a count that retains its types, an inverse that retains both oriented relations, and actual returns in which an achieved difference changes what the next act can receive. A repeated cycle can reproduce the same answer indefinitely; a completed return carries a changed relation into the conditions of another answer. The stroke has to retain that difference as it becomes something we can operate upon.
