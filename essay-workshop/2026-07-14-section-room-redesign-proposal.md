...
6. Mandatory pre-load: `essay-workshop/return-of-zero-orienting-principles.md`; the coverage table must reproduce §V's station↔room map; references that cannot be verified on disk do not ship (rule 4).
