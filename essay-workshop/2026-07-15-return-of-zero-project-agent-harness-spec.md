...
- one sovereign manuscript at `essay-workshop/THE-RETURN-OF-ZERO.md`;
...
`essay-workshop/active-ideas.json` is the only project-agent continuity file introduced by this harness. It is optional and changed only by an explicit command. Each retained idea records:
